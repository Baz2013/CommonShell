...
set -A host 0 10.124.0.31 10.124.0.31 10.124.0.31 10.124.0.31 10.124.0.31 10.124.0.32 10.124.0.32 10.124.0.32 10.124.0.32 10.124.0.32
...
send_file(){
	...
	./cmd.sh ${dst_user} ${dst_host} ${password} 2>/dev/null
}
